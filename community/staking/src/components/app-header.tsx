...
export function AppHeader({ links = [] }: { links: { label: string; path: string }[] }) {
  ...
  return (
    <header className="relative z-50 px-4 py-3 border-b border-neutral-200 dark:border-neutral-800 bg-neutral-50/80 dark:bg-neutral-950/80 backdrop-blur-sm dark:text-neutral-400">
